...
},beforePageText:"页码",afterPageText:"of {pages}",displayMsg:"本页显示 {from}-{to}, 共有 : {total} 个",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.filebox.defaults=$.extend({},$.fn.textbox.defaults,{buttonIcon:null,buttonText:"点击选择文件",buttonAlign:"right",inputEvents:{}});
})(jQuery);
(function($){
function _4f2(_4f3){
